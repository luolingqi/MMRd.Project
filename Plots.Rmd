...
df_1_pls_1 <- cbind(df_1[,! names(df_1) %in% c("Fraction_Genome_Altered","Cancer_Type_NEW","CLASSIFICATION_PLOT","Row.names","Sample_ID","Tumor_Purity","Primary_Site","Metastatic_Site","Sample_Type","Race","Ethnicity")]+1, df_1[,c("Fraction_Genome_Altered","Cancer_Type_NEW","CLASSIFICATION_PLOT","Tumor_Purity","Primary_Site","Metastatic_Site","Sample_Type","Race","Ethnicity")])

for(i in metrics) {
  # compare means between MMRd groups, grouped by cancer types
  corr_tmp <- compare_means(as.formula(paste0(i," ~ CLASSIFICATION_PLOT")), data = df_1[-which(df_1$CLASSIFICATION_PLOT=="Delete")], group.by = "Cancer_Type_NEW")
  ...
  assign(paste0("p_",i), plotCorr.MMRd(df_1_pls_1,i))
